...
if(!empty($_POST["login"])) {
  $result = mysqli_query($conn,"SELECT * FROM admin WHERE adminEmail='" . $_POST["adminEmail"] . "' and adminPassword = '". $_POST["adminPassword"]."'");
    ...
    <center><div class="wrapper">
        ...
        <form action="admindashboard.php" method="post">
            ...
            <div class="form-group">
              ...
              <div><input name="adminEmail" type="text" class="form-control"></div>
            </div>
            <div class="form-group">
              <div><label for="password">Password</label></div>
              <div><input name="adminPassword" type="password" class="form-control"> </div>
          </div>
          <div class="form-group">
