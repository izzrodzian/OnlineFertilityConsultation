...
<head>
  ...
  <title>Fertility Assessment</title>
...
<br>
<center>
  <h1><font color="#3377A9">Understand your fertility</font></h1>

<br><br>
<table border="0" style="width: 75%">
<div class="wrapper">
  <tr>
    <td>As a member of Virtus Health, IVFAustralia has more experienced fertility specialists, offering many treatment options, in more locations, to create more babies than any other fertility group. Some babies need a little help to get started, so speak to Australia's #1 for fertility today.
    <br><br>
...
<table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><font color="#0EAB8F"><b>HOW TO BOOST YOUR NATURAL FERTILITY</b></font>
      <br><br>
      If you’re trying for a baby at home, the timing of when you and your partner have sex is critical. The most fertile days in your cycle are the days leading up to ovulation, before the egg if released from the ovary. We recommend regular intercourse every two days during this time to give you the best chance of conception that month. Calculate the most fertile days in your cycle.
      <br><br>
      There may also be improvements you could make to boost egg or sperm health and your overall fertility. 
      <ul>
        <li>Stop smoking and recreational drug use
        <li>Optimise your weight for a healthy BMI. Being under or over weight can affect your chances of conceiving
        <li>Moderate alcohol and caffeine intake
        <li>Consider vitamin supplements and women should take folic acid for 3 months prior to conception 
      </ul>
...
<table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><font color="#0EAB8F"><b>WHAT CAN AFFECT YOUR FERTILITY?</b></font>
      <br><br>
      A number of factors can affect your chance of conceiving.
      <br><br>
      For women the most common causes of infertility include:
      <ul>
        <li>the age of the woman which affects the quality and quantity of eggs
        <li>ovulation disorders that impact the ovaries ability to produce an egg eg: polycystic ovarian syndrome
        <li>structure of the fallopian tubes eg: blockages can prevent the sperm and egg meeting; and
        <li>the health and condition of the uterus eg: presence of endometriosis or fibroids
      </ul>
      For men the most common causes of infertility include: 
      <ul>
      <li>problems with sperm production due to testicular failure or obstruction/blockage
      <li>the size, shape and motility of sperm
      <li>presence or absence of sperm antibodies
      <li>high levels of sperm DNA fragmentation; or
      <li>genetic conditions eg: cystic fibrosis or chromosomal abnormalities
      </ul>
   </td>
    </tr>
  </div></table>
 ...
 <table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><font color="#0EAB8F"><b>WHAT’S INVOLVED IN A FERTILITY CONSULTATION?</b></font>
      <br><br>
