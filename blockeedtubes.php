...
<head>
  ...
  <title>Blocked Fallopian Tubes</title>
...
<br>
<center>
  <h1><font color="#3377A9">Blocked Fallopian Tubes</font></h1>
...
<table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><font color="#0EAB8F"><b>WHAT ARE FALLOPIAN TUBES?</b></font>
      <br><br>
...
<table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><font color="#0EAB8F"><b>HOW DO FALLOPIAN TUBES GET BLOCKED?</b></font>
      <br><br>
     The most common cause of blocked fallopian tubes is pelvic inflammatory disease (PID). Other potential causes include: <br>
      - Current or history of an STD infection specifically chlamydia or gonorrhea <br>
      - History of uterine infection caused by an abortion or miscarriage <br>
 ...
 <table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
    <td><font color="#0EAB8F"><b>TYPES OF BLOACKED FALLOPIAN TUBES?</b></font>
    <br><br>
    The types of blockages are determined depending where in the tube the blockage is occurring.
    <ul>
    <li>Distal tubal occlusion - the fallopian tube is blocked at the end closest to the ovary. This condition is commonly known as hydrosalpinx, usually caused by STIs.

    <li>Midsegment blockage - the middle segment of fallopian tube is blocked. It is a common target of sterilisation interventions, i.e. tubal ligation.

    <li>Proximal tubal occlusion - the end of fallopian tube ( near uterus ) is blocked. This may be caused by infection due to abortion, miscarriages, cesarean section, or pelvic inflammatory disease.
    </ul>
   </td>
    </tr>
  </div></table>
 ...
 <table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
    <td><font color="#0EAB8F"><b>BLOCKED FALLOPIAN TUBES SYMPTOMS</b></font>
    <br><br>
...
<table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
    <td><font color="#0EAB8F"><b>HOW TO DIAGNOSE BLOCKED FALLOPIAN TUBES</b></font>
    <br><br>
