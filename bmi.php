...
<head>
  ...
  <title>BMI for Pregnancies</title>
...
<br>
<center>
  <h1><font color="#3377A9">BMI for Pregnancies</font></h1>

<br><br>
<table border="0" style="width: 75%">
<div class="wrapper">
  <tr>
    <td>As a woman’s weight can affect fertility across both ends of the spectrum, your body mass index (BMI) is a useful way of identifying if your weight is within a healthy range. Find out what an ideal BMI is for pregnancy.</td>
  </tr>
  </div></table>
...
<table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><font color="#0EAB8F"><b>DESCRIPTION/EXPLANATION OF BMI</b></font>
      <br><br>
...
<table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><font color="#0EAB8F"><b>RELATIONSHIP BETWEEN BMI AND PREGNANCY FERTILITY </b></font>
      <br><br>
...
<table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><font color="#0EAB8F"><b>WHAT IS AN IDEAL/HEALTHY BMI IS FOR PREGNANCY/CONCEIVING?</b></font>
      <br><br>
...
<table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><font color="#0EAB8F"><b>WHAT TO DO IF YOU’RE NOT IN THE IDEAL BMI RANGE?</b></font>
      <br><br>
