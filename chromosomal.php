...
<br>
<center>
  <h1><font color="#3377A9">Chromosonal Abnormalities</font></h1>

<br><br>
<table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><font color="#0EAB8F"><b>WHAT IS A CHROMOSOME?</b></font>
      <br><br>
 ...
 <table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><font color="#0EAB8F"><b>TESTING FOR GENETIC DISEASE?</b></font>
      <br><br>
      ...
      <br>
      <ul>
        <li>Huntington's disease (direct and exclusion)
        <li>Cystic Fibrosis
        <li>Thalassaemia
        <li>Duchenne muscular dystrophy
        <li>Fragile–X
        <li>BRCA1/BRCA2 (hereditary breast / ovarian cancer)
      </ul>
      <br><br>
   </td>
    </tr>
