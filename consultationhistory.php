...
<tr>
  ...
  <td><h1>Patient Consultation History</h1></td>
</tr>
</table>
</center>
<br>
    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true"><li class="nav-item">
                ...
                </li><li class="nav-item"><a class="nav-link link text-white display-4" href="logout.php"><span class="mobi-mbri mobi-mbri-user mbr-iconfont mbr-iconfont-btn"></span>
...
<center>
<table border="0">
<td><a href="patientdashboard.php">
  <input type="button" class="btn btn-primary" value="Patient Dashboard">
</a></td>
</tr>
</table>
</center>
