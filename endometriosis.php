...
<br>
<center>
  <h1><font color="#3377A9">Endometriosis and Fertility</font></h1>
...
<table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><h4><font color="#0EAB8F">What is Endometriosis?</font></h4>
...
<table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><h4><font color="#0EAB8F">How does endometriosis affect fertility?</font></h4>
...
<table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><h4><font color="#0EAB8F">What causes endometriosis?</font></h4>
      Whilst it is unclear exactly what causes endometriosis there are a few theories:
      <ul>
        <li><b>Retrograde (backward) menstruation:</b> During menstruation some of the menstrual blood that carries endometrial tissue cells flows backwards along the fallopian tubes into the pelvis where the cells can then implant and grow.
        <li><b>Coelomic Metaplasia:</b> Suggests that the cells lining the pelvic organs are able to change their structure and function to become endometrial cells when they are influenced by certain conditions. Triggers could include puberty or oestrogen surges.
        <li><b>Altered immunity:</b> Suggests that development might be related to a deficiency in your immune system’s ability to recognise the presence of endometrial tissue in abnormal locations and eliminate it.
      </ul>
   </td>
    </tr>
  </div></table>
...
<table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
    <td><h4><font color="#0EAB8F">What are the symptoms of endometriosis?</font></h4>
    ...
    Factors that could indicate a higher incidence of endometriosis include:
      <ul>
      <li>Early puberty (first period before 11 years of age)
      <li>Advanced maternal age at first child birth
      <li>Heavy, painful periods
      <li>Long periods (more than 5 days) or short cycles (less the 27 days between periods)
      <li>A family history of close relatives with endometriosis
      <li>If you experience these symptoms and are also having trouble conceiving naturally, you should seek advice from your GP or a fertility specialist.
      </ul>
   </td>
    </tr>
  </div></table>
 ...
 <table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
    <td><h4><font color="#0EAB8F">How do you treat endometriosis?</font></h4>
