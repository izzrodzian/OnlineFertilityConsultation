...
<head>
  ...
  <title>Frequently Asked Question (FAQ)</title>
...
<table id="myTable" style="margin-top: 20px; width: 75%" align="center">
    ...
    <tr>
      ...
      <td>Premature ovarian failure is one cause of female infertility. Premature ovarian failure means that a woman’s ovaries stop producing hormones or mature eggs long before the normal age of menopause. The average age at menopause is 51.
      <br><br>
      A woman is born with all of the eggs she will ever have and cannot produce more. Over time and with each menstruation, the supply of eggs decreases until the ovarian reserve is empty and results in menopause. Premature ovarian failure may be temporary or permanent, but is often a side effect of damage to the ovaries from chemotherapy or from radiation therapy that is aimed at the pelvic area.</td>
    </tr>
    <tr>
      <td>What is the difference between an egg and an embryo?</td>
      <td>An egg, also called an oocyte, is a female reproductive cell. An egg contains only the genetic material of a woman. An embryo is an egg that has been fertilized with a sperm, which means it contains genetic material from both a woman and a man.</td>
    </tr>
    <tr>
      <td>How long can eggs, embryos and ovarian tissue be frozen?</td>
