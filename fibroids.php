...
<table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><h4><font color="#0EAB8F">What are uterine fibroids?</font></h4>
...
<table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><h4><font color="#0EAB8F">What are the cause of Fibroids?</font></h4>
 ...
 <table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><h4><font color="#0EAB8F">What are the symptoms of fibroids?</font></h4>
...
<table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><h4><font color="#0EAB8F">Can fibroids affect your fertility?</font></h4>
...
<table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><h4><font color="#0EAB8F">What effect do fibroids have on fertility?</font></h4>
      Whether fibroids affect your fertility, and therefore whether you need them removed, depends on the size of the uterus and where in the uterus, the fibroid is located. 
      <br><br>
      ...
      <ul>
      <li>Where the fibroid is very large distorting the lining of the uterus
      <li>Where the fibroid is located inside the uterus itself (called a submucous fibroid).
      </ul>
...
<table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><h4><font color="#0EAB8F">How to treat fibroids</font></h4>
