...
<head>
  ...
  <title>Online Fertility Consultation System</title>
    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-toggleable-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true"><li class="nav-item">
                ...
                </li><li class="nav-item dropdown"><a class="nav-link link text-white dropdown-toggle display-4" href="profile.php" data-toggle="dropdown-submenu" aria-expanded="false"><span class="mobi-mbri mobi-mbri-user mbr-iconfont mbr-iconfont-btn"></span>
                       My Account</a>
                       <div class="dropdown-menu"><a class="text-white dropdown-item display-4" href="profile.php" aria-expanded="false">My Profile</a>
                        <a class="text-white dropdown-item display-4" href="index.php" aria-expanded="false">Log Out</a></li> </ul> 
        </div>
        ...
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                <h1 class="mbr-section-title mbr-bold pb-3 mbr-fonts-style display-1">
                    ONLINE FERTILITY CONSULTATION SYSTEM</h1>
...
<section class="features3 cid-rnfhyfssrv" id="features3-b">
    ...
    <div class="container">
        <div class="media-container-row">
                ...
                <div class="card-wrapper">
                    ...
                    <div class="card-box">
                        ...
                        <p class="mbr-text mbr-fonts-style display-7">
                            Find out more regarding the fertility treatments and procedures.</p>
                    </div>
                    <div class="mbr-section-btn text-center"><a href="planning.html" class="btn btn-primary-outline display-4">
                            Find Out More
                        </a></div>
                </div>
            </div>
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="assets/images/mbr-676x406.jpg" alt="Mobirise" title="">
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7">
                            Treatments</h4>
                        <p class="mbr-text mbr-fonts-style display-7">
                            Find out more regarding the fertility treatments and procedures.
                        </p>
                    </div>
                    <div class="mbr-section-btn text-center"><a href="treatment.html" class="btn btn-primary-outline display-4">
                            Find Out More</a></div>
                </div>
            </div>
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    ...
                    <div class="mbr-section-btn text-center"><a href="faq.html" class="btn btn-primary-outline display-4">Find Out More</a></div>
                </div>
            </div>
...
<section once="footers" class="cid-rneYzQ0GZp" id="footer6-6">
        ...
        <div class="media-container-row align-center mbr-white">
            <div class="col-12">
                <p class="mbr-text mb-0 mbr-fonts-style display-7">
                    © Nurain Izzati Rodzian // Final Year Project - Bachelor in Software Engineering // UniKL MIIT 2019</p>
            </div>
        </div>
    </div>
</section>
