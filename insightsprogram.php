...
<head>
  ...
  <title>Fertility Insights Program</title>
...
<br>
<center>
  <h1><font color="#3377A9"> Fertility Insights Program </font></h1>

<br><br>
<table border="0" style="width: 75%">
<div class="wrapper">
  <tr>
    <td>Starting out on your journey to parenthood can be an exciting time, and there are a number of ways you can improve your chances of falling pregnant naturally.  Our Fertility Insights Program will help you to understand the factors affecting your fertility, and set you on a fast track path to pregnancy in few simple to follow steps.</td>
  </tr>
  </div></table>
  ...
  <div class="wrapper">
  <tr>
     <td><font color="#0EAB8F"><b>STEP 1: UNDERSTAND YOUR FERTILITY WINDOW </b></font>
      <br><br>
      The timing of intercourse plays a critical role in conception.  Having sex 24-48 hours prior to ovulation gives a woman the best chance of falling pregnant because it is at this time that she is at her most fertile. Based on the length of a female’s menstrual cycle, our online fertile window calculator will tell you when your ‘fertile window’ is, and you can download the results to your Smartphone calendar. Why not give it a try now?
      <br><br>
      If you have trouble determining your fertile window, have irregular cycles or your cycle varies month to month - bulk billed ovulation cycle tracking can help you confidently understand when ovulation takes place so you can plan when to have intercourse to give you the best chance of conception.
 ...
 <br>
  ...
  <div class="wrapper">
  <tr>
     <td><font color="#0EAB8F"><b>STEP 2: OPTIMISE YOUR HEALTH AND LIFESTYLE</b></font>
      <br><br>
      ...
      <br>
      <ul>
        <li>Stopping smoking, as it reduces fertility by around 40%, and also increases the risk of miscarriage
        <li>Reducing alcohol and caffeine intake
        <li>Optimising weight by following a healthy diet and exercise routine
        <li>For a female, taking folic acid, ideally for three months prior to trying to conceive, as it is one of the few nutrients known to prevent neural tube birth defects such as spina bifida
        <li>Managing known conditions, such as diabetes. This improves the chances of a healthy baby, and reduces the risk of miscarriage
        <li>Visiting the GP for antenatal blood tests, including checks for rubella and chicken pox status, blood group, Rh factor, Hepatitis B and Hepatitis C
        <li>Reviewing current medications and any implications for pregnancy with a GP
        <li>Understanding your menstrual cycle
  ...
  <div class="wrapper">
  <tr>
     <td><font color="#0EAB8F"><b>STEP 3: INITIAL CONSULTATION WITH A FERTILITY SPECIALIST </b></font>
      <br><br>
      If you’ve tried steps one to four, and are not falling pregnant as quickly as you’d hoped, we recommend you have a consultation with one of our Fertility Specialists. This is especially important if you are under 35 and have been trying for 12 months or more, or if you are over 35 and haven’t fallen pregnant after six months of trying.
      <br><br>
...
<br>
  ...
  <div class="wrapper">
  <tr>
     <td><font color="#0EAB8F"><b>STEP 4: START PERSONALIZED PREGNANCY PLAN</b></font>
      <br><br>
     Your test results will be returned promptly and your leading Fertility Specialist will guide you through them, recommending the best approach to help you achieve pregnancy and get your plans for a family underway.
      <br><br>
     Based on your individual circumstances, we will help you on a journey to parenthood that is highly personalised and right for you. For some couples, non or minimally invasive procedures such as timed conception and ovulation induction are a first line treatment option to increase fertility. For others, IVF or ICSI treatment may be recommended. 
