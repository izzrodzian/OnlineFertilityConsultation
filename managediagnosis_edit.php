...
if(isset($_GET['diagnosisID'])){
  ...
  if(!isset($diagnosisID)){
    echo "Empty Diagnosis ID! check again!";
    exit;
  }

  // get diagnosis data
  $query = "SELECT * FROM diagnosisDB WHERE diagnosisID = '$diagnosisID'";
...
<head>
  ...
  <title>Edit Diagnosis Details</title>
...
<body>
  ...
  <br>
    <center><div class="wrapper">
        <h2>Edit Diagnosis Details</h2>
        <br>
        <form method="post" action="edit_diagnosis.php" enctype="multipart/form-data">
        <table class="table">
          <tr>
            <th>Diagnosis ID</th>
            <td><input type="text" name="diagnosisID" value="<?php echo $row['diagnosisID'];?>" readOnly="true"></td>
          </tr>
          <tr>
            <th>Diagnosis</th>
            <td><input type="text" name="diagnosis" value="<?php echo $row['diagnosis'];?>" required></td>
          </tr>
          <tr>
            <th>Symptoms</th>
            <td><textarea rows="10" name="symptoms"  cols="40"><?php echo $row['symptoms'];?></textarea></td>
          </tr>
          <tr>
            <th>Explanation</th>
            <td><textarea rows="10" name="explanation" cols="40"><?php echo $row['explanation'];?></textarea></td>
          </tr>
          <tr>
            <th>Treatments</th>
            <td><textarea rows="10" name="treatments" cols="40"><?php echo $row['treatments'];?></textarea></td>
          </tr>
        </table>
         <input type="submit" name="save_change" value="Change" class="btn btn-primary">
        <input type="reset" value="Reset" class="btn btn-default">
      </form>
      <a href="managediagnosis.php" class="btn btn-success">Confirm</a>
    </div> </center> 
</body>
</html>