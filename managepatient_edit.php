...
if(isset($_GET['patientID'])){
  ...
  if(!isset($patientID)){
    echo "Empty patientID ID! check again!";
    exit;
  }
  ...
  <br>
    <center><div class="wrapper">
        ...
        <table class="table">
          <tr>
            <th>Patient ID</th>
            <td><input type="text" name="patientID" value="<?php echo $row['patientID'];?>" readOnly="true"></td>
          </tr>
          <tr>
            <th>Patient Email</th>
            <td><input type="text" name="patientEmail" value="<?php echo $row['patientEmail'];?>" required></td>
          </tr>
          <tr>
            <th>Patient Password</th>
            <td><input type="text" name="patientPassword" value="<?php echo $row['patientPassword'];?>" required></td>
          </tr>
          <tr>
            <th>Patient Name</th>
            <td><input type="text" name="patientName" value="<?php echo $row['patientName'];?>" required></td>
          </tr>
          <tr>
            <th>Patient IC Number</th>
            <td><input type="text" name="patientIC" value="<?php echo $row['patientIC'];?>" required></td>
          </tr>
          <tr>
            <th>Patient Maritak Status</th>
            <td><input type="text" name="patientMaritalStatus" value="<?php echo $row['patientMaritalStatus'];?>" required></td>
          </tr>
          <tr>
            <th>Patient Phone</th>
            <td><input type="text" name="patientPhone" value="<?php echo $row['patientPhone'];?>" required></td>
          </tr>
        </table>
        <input type="submit" name="save_change" value="Change" class="btn btn-primary">
        <input type="reset" value="Reset" class="btn btn-default">
      </form>
      <a href="managepatient.php" class="btn btn-success">Confirm</a>
    </div> </center>   
</body>
</html>