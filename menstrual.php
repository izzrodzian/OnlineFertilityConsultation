...
<br>
<center>
  <h1><font color="#3377A9">Menstrual Cycle</font></h1>
...
<table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><font color="#0EAB8F"><b>PHASE OF MENSTRUAL CYCLE</b></font>
      <br><br>
      ...
      <br><br>
      <b> Phase 1: The Follicular Phase <br>
          Phase 2: Ovulation (release of the egg) <br>
          Phase 3: After ovulation<br>
      </b>
   </td>
    </tr>
  </div></table>
...
<table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><font color="#0EAB8F"><b>COMMON MENSTRUAL CYCLE ABNORMALITIES</b></font>
      <br><br>
      <ul>
        <li>Amenorrhea
        <li>Anovulation
        <li>Hyperprolactinemia
        <li>Luteal phase defect
      </ul>
   </td>
    </tr>
  </div></table>
 ...
 <table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><font color="#0EAB8F"><b>MOST FERTILE TIME IN CYCLE</b></font>
      <br><br>
...
<table border="0" style="width: 75%">
  <div class="wrapper">
  <tr>
     <td><font color="#0EAB8F"><b>HOW DO I KNOW WHEN I OVULATE?</b></font>
      <br><br>
