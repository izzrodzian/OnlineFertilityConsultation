        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true"><li class="nav-item">
                    ...
                    <a class="nav-link link text-white dropdown-toggle display-4" data-toggle="dropdown-submenu" aria-expanded="true"><span class="mobi-mbri mobi-mbri-user-2 mbr-iconfont mbr-iconfont-btn"></span>
                        Account</a><div class="dropdown-menu"><a class="text-white dropdown-item display-4" href="logout.php" aria-expanded="false">Log Out</a></div>
                </li></ul>
        </div>
    </nav>
</section>
...
<h2>Patient Dashboard</h2></center>
...
<table border="0">
<tr>
  <td><img src="images/profile.png" style="width:128px;height:128px;"></td>
  <td><img src="images/consultation.png" style="width:128px;height:128px;"></td>
  <td><img src="images/dashboard.png" style="width:128px;height:128px;"></td>
</tr>
<tr>
<td><a href="profile.php">
  <input type="button" class="btn btn-primary" value="Profile">
</a></td>
<td><a href="consultationhistory.php">
  <input type="button" class="btn btn-primary" value="Consultation History">
</a></td>
<td><a href="consultation.php">
  <input type="button" class="btn btn-primary" value="New Consultation">
</a></td>
</tr>
</table>
</center>
