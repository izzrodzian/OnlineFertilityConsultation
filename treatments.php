    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="menu-logo">
            <div class="navbar-brand">
                ...
                <span class="navbar-caption-wrap"><a class="navbar-caption text-white display-4" href="index.php">ONLINE FERTILITY CONSULTATION SYSTEM</a></span>
            </div>
        </div>
...
<button type="button" style="width: 75%" class="collapsible">Ovulation Induction (OI)</button>
<div class="content" style="width: 75%">
  <p>A simple treatment that uses medication to help stimulate your hormones and encourage ovulation. Read more about ovulation induction.</p>
</div>

<button type="button" style="width: 75%" class="collapsible">Artificial Insemination (IUI)</button>
<div class="content" style="width: 75%">
  <p>A technique that involves inserting prepared sperm into the female’s uterus close to the time of ovulation. Find out more about artificial insemination.</p>
</div>


<button type="button" style="width: 75%" class="collapsible">IVF Treatment</button>
<div class="content" style="width: 75%">
  <p>After a course of ovarian stimulation, eggs are collected from the ovaries and fertilised with sperm in a laboratory. One of the resulting embryos is then transferred back into the uterus. Read more about IVF treatment.</p>
</div>

<button type="button" style="width: 75%" class="collapsible">ICSI Treatment</button>
<div class="content" style="width: 75%">
  <p>A different, more sophisticated form of IVF where the scientist injects a single sperm into the egg to assist fertilisation. This technique is an excellent treatment if the sperm is of poor quality. Read more about ICSI treatment.</p>
</div>

<button type="button" style="width: 75%" class="collapsible">Frozen Embryo Transfer (FET)</button>
<div class="content" style="width: 75%">
  <p>Any additional embryos created from an IVF cycle can be frozen and stored for future use. These embryos can then be thawed and transferred if more than one treatment cycle is needed. Find out more about frozen embryo transfer.</p>
</div>

<button type="button" style="width: 75%" class="collapsible">Fertility Surgery</button>
<div class="content" style="width: 75%">
  <p>Surgery may be required to further investigate or treat conditions making it difficult for you to conceive such as endometriosis or fibroids for women, or to surgically retrieve sperm. Find out more about fertility surgery.</p>
</div>

<button type="button" style="width: 75%" class="collapsible">Advanced Science</button>
<div class="content" style="width: 75%">
  <p>As part of our parent group, IVF Australia invests extensively in scientific research to improve knowledge of IVF and, consequently, outcomes for our patients. Read more about the research of our doctors and scientists here.</p>
</div>

<button type="button" style="width: 75%" class="collapsible">Artificial Intelligence in IVF</button>
<div class="content" style="width: 75%">
  <p>A new artificial intelligence system, called Ivy, to predict the likelihood of a viable pregnancy from transfer of an individual embryo in a woman undergoing IVF.</p>
</div>

<button type="button" style="width: 75%" class="collapsible">Variations in IVF</button>
<div class="content" style="width: 75%">
  <p>There are a wide range of variations in IVF techinque which many of our patients ask us about, such as assisted hatching, PolScope and digital high magnification. Read more about variations in IVF.</p>
</div>
